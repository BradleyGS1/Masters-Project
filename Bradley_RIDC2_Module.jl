...
"""
    RIDC2(f::Function, u0::Vector{ComplexF64}, T::ComplexF64, N::Int64, M::Int64, K::Int64) -> (t::Vector{ComplexF64}, u::Vector{ComplexF64})
...
parameters used and the nature of the ODE to be solved. 
...
function RIDC2(
    ...
    function correct(
        u_corr0::Vector{ComplexF64}, 
        u_prev_lvl::Matrix{ComplexF64}, 
        ...
        f_prev_lvl = zeros(ComplexF64, 2*(M+1), d)
        for i in 1:2*(M+1)
    ...
    u_tensor = zeros(ComplexF64, M+1, N+1, d)
    # Initial condition
        ...
        for m in 1:M+1
            ...
            for i in 1:3*M+2
                ...
                if m == 1
                    ...
                    u_prev_lvl = zeros(ComplexF64, 2*M+2, d)
